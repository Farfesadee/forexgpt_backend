...
#           - Sharpe ratio    >= 1.0
#           - Total return    >  0 %
#           - Max drawdown    > -15 % (stored as negative e.g. -30.24)
#         """
...
#         # max_drawdown_pct comes in as a negative number e.g. -30.24
#         # so we check it's not worse than -15%
...
#                 "Explain clearly why it worked, what the metrics reveal about "
#                 "its strengths, what market conditions favoured it, "
#                 "and what risks the trader should still watch going forward."
#             )
#         else:
#             instruction = (
#                 f"This {strategy_type} strategy FAILED. "
#                 "Explain clearly why it failed, what each metric reveals about "
...
#         Works for any strategy type — parameters are optional.
#         """
#         def fmt(key, label, suffix=""):
...
#         # Include parameters section only if provided
#         params_section = ""
#         if ctx.parameters:
...
# 1. What does the overall verdict say — did this strategy pass or fail?
# 2. What do each of these metrics tell me about how my strategy performed?
# 3. Why did this {ctx.strategy_type} strategy likely produce these results?
# 4. What market conditions would have helped or hurt this strategy?
# 5. What conceptual improvements would you suggest and why?"""
...
The backtest context is stored as a single 'system' role message
at the top of the conversation so it survives across sessions.
"""
...
class MentorService:
    ...
    async def start_backtest_conversation(
        ...
        if not DEV_MODE:
            ...
            # 2. Persist backtest context as a 'system' role message
            context_blob = json.dumps(backtest_context.model_dump(), indent=2)
            self.db.mentor.add_message(
                conversation_id = conversation_id,
                user_id         = user_id,
